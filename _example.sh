...
################################################################################
# delete PNF from A%AI
# Please note that the delete operation requires the current value of
# of the 'resource-version' attribute. This value is generated by A&AI only.
# Therefore please use getPnf script to read the value and use it as 
# second parameter of the deletePnf script.
./deletePnf.sh 1234 <use getPnf to place the resource-version value here>
./deletePnf.sh FYNG <use getPnf to place the resource-version value here>
./deletePnf.sh R2D2 <use getPnf to place the resource-version value here>
./deletePnf.sh 7DEV <use getPnf to place the resource-version value here>
./deletePnf.sh nSky <use getPnf to place the resource-version value here> 
./deletePnf.sh 1OSF <use getPnf to place the resource-version value here>
