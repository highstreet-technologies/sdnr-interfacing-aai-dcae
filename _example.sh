...
./deletePnf.sh 6352 <use getPnf to place the resource-version value here>
./deletePnf.sh MP06 <use getPnf to place the resource-version value here>
./deletePnf.sh MP20 <use getPnf to place the resource-version value here>
./deletePnf.sh MSS8 <use getPnf to place the resource-version value here>
./deletePnf.sh DWHQ <use getPnf to place the resource-version value here> 
./deletePnf.sh DWHC <use getPnf to place the resource-version value here>
